  ...
  return (
    <LampContainer>
      <motion.h1
        ...
        className="-mt-40 bg-gradient-to-br from-neutral-300 to-neutral-500 py-4 bg-clip-text text-center text-6xl font-medium tracking-tight text-transparent md:text-7xl"
      >
        Plans That
        <br /> Fit You Best
      </motion.h1>
